...
class _QuizPageState extends State<QuizPage> {
                ...
                widget.data.cards.map((e) {
                  return  Padding(
                    ...
                    child: Container(
                      ...
                      decoration: BoxDecoration(
                          color: resolveColorForAnswer(e.answered), shape: BoxShape.circle),
                      child: Center(
                        child: IconButton(icon: Icon(resolveIconForAnswer(e.answered)), onPressed: () {
                          setState(() {
    ...
    return Column(
                  children: [
                    Container(
                      ...
                      decoration: BoxDecoration(
                          color: Color.fromRGBO(179, 239, 178, 1), shape: BoxShape.circle),
                      child: Center(
                        child: Text("$score",
  ...
  void updateScore(int scoreVal) {
    setState(() {
      ...
      score += scoreVal;
      if (cardIndex + 1 < widget.data.cards.length)
        cardIndex += 1;
      else {
        ...
        result.then((value) => Navigator.pop(context, widget.data));
      }
    });
  }
      ...
      content: Container(
        ...
        child: Column(
          children: [
            ...
            Text(
              "Time: ${Constants.wrapZero(widget.data.time)}s",
              style: Theme.of(context).textTheme.headline6,
            ),
            Spacer(
              flex: 2,
