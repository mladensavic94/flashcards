...
class FakeRepository extends Repository{
  ...
  List<Quiz> data = List.of([Quiz("Flutter","sitna slova", [], 0, 0),
    Quiz("This is an example of a long title that should go into wrap","druga sitna slova", [CardInfo("What lang is this app written", "Dart", QuestionState.UNANSWERED), CardInfo("What is this", "IDK2",QuestionState.UNANSWERED)], 0, 0),
